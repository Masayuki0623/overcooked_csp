...
# LLAMA_ADDRESS is not used in this project, so we skip this initialization
# nodes = [
#     {
#         'chat': f'http://{os.environ.get("LLAMA_ADDRESS", "localhost")}/api/v1/chat',
#         'chateval': f'http://{os.environ.get("LLAMA_ADDRESS", "localhost")}/api/v1/chateval'
#     },
# ]
